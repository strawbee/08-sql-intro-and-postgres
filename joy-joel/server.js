...
// It's interfacing with the database; if the table called "articles" currently doesn't exist, it creates the table with all of its rows and schema, and if the query is successful, it calls the loadArticles() function.
loadDB();
